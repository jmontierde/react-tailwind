...
const Features = () => {
  return (
    <div className='flex container flex-col mx-auto align-center p-6 mt-12 space-y-12 md:flex-row md:space-y-0'>
      <div className='space-y-8 md:w-1/2 text-center md:text-left'>
        <h2 className='font-bold text-xl md:text-2xl'>What's different about <br />Manage?</h2>
      ...
      <div>
        <ol className='flex flex-col space-y-6 text-sm text-left px-12 md:text-left md:base'>
          ...
          <span className='ml-14'>See how your day-to-day tasks fit into the wider vision. Go from tracking progress at <br />
          ...
          <span className=' ml-14'>Set interval delivery estimates and track progress toward company goals. Our <br />
          ...
          <span className='ml-14'>Stop jumping from one service to another to communicate, store files, track task and <br />
